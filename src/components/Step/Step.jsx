...
//         <button
//           className="w-full sm:w-auto bg-brand-navy hover:bg-opacity-90 transition-colors text-white px-8 py-3.5 sm:py-3 rounded-lg font-medium inline-flex items-center justify-center gap-2 cursor-pointer "
